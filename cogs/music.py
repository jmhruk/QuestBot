...
class YTDLSource(discord.PCMVolumeTransformer):
    ...
    async def create_source(cls,
        ...
        return cls(ctx,
                   discord.FFmpegPCMAudio(info['url'], **cls.FFMPEG_OPTIONS, executable="C:\\ffmpeg\\bin\\ffmpeg.exe"),
                   data=info)
...
class music(commands.Cog):
    ...
    @commands.command(name='removefromqueue')
    async def _removefromqueue(self, ctx: commands.Context, index: int):
    ...
    async def _loop(self, ctx: commands.Context):
        """Loops the currently playing song, re-run command to unloop
        """
